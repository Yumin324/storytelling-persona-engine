...
class Settings(BaseSettings):
    ...
    kling_video_model: str = Field(default="kling-3.0", alias="KLING_VIDEO_MODEL")
    ...
    api_timeout_image_seconds: int = Field(default=240, alias="API_TIMEOUT_IMAGE_SECONDS")
    ...
    def provider_readiness(self) -> dict[str, bool]:
        return {
            ...
            "kling": bool(self.kling_api_key and self.kling_api_base_url),
